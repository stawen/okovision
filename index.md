...
Attention: Okovision est une logiciel serveur qui est accessbile depuis votre navigateur. **Ce n'est pas une application qui s'installe sur W10 ou Mac**
...
## Mode d'emploi
  ...
  * Configuration Générale
   ...
   * Importation fichier CSV depuis chaudière 
   * Importation manuelle du fichier CSV 
   * Importation en masse de fichier CSV 
   * [Calcul Synthèse journalière](/md/synthese.md)
   * [Information générale de votre installation Okofen](/md/infoGenerale.md)
   * [Gestion de la Matrice (Modification / Mise a jour / Suppresion )](/md/updateMatrix.md)
   * [Définition des saisons](/md/season.md)
   * Gestion des evenements de silo et cendrier
